...
describe.skip('<CodeEditor />', () => {
  ...
  it('shows an empty initial value by default', () => {
    const { getByTestId } = render(<CodeEditor language="python" testID="code-editor" />);
  ...
  it('shows the given initial value on mount', () => {
    const { getByTestId } = render(
      <CodeEditor language="python" value="test-value" testID="code-editor" />
    );
    const textInput = getByTestId('code-editor-text-input');
    const { value } = textInput.props;
  ...
  it('shows no line numbers when showLineNumbers is false', () => {
    const { queryByText } = render(
      <CodeEditor language="python" value={'test\ntest\ntest'} showLineNumbers={false} />
    );
  ...
  it('makes the editor uneditable when readOnly is true', () => {
    const { getByTestId } = render(<CodeEditor language="python" testID="code-editor" readOnly />);
    const textInput = getByTestId('code-editor-text-input');
    const { editable } = textInput.props;
  ...
  it('focuses the editor on mount when autoFocus is true', () => {
    const { getByTestId } = render(<CodeEditor language="python" testID="code-editor" autoFocus />);
    const textInput = getByTestId('code-editor-text-input');
    const { autoFocus } = textInput.props;
